...
class ClientReportPdfService {
    ...
    return pw.Expanded(
      child: pw.Container(
        ...
        decoration: pw.BoxDecoration(
          color: _lightGray,
          // ✅ FIX: Removed borderRadius to allow the custom left border
  ...
  pw.Widget _buildLivraisonTable(List<LivraisonReportItem> items) {
    return pw.Table.fromTextArray(
      headers: ['Date', 'Code BL', 'Destinataire', 'Statut'],
      columnWidths: { 0: const pw.FixedColumnWidth(60), 3: const pw.FixedColumnWidth(70) },
      data: items.map((i) => [
  ...
  pw.Widget _buildInstallationTable(List<InstallationReportItem> items) {
    return pw.Table.fromTextArray(
      headers: ['Date', 'Code', 'Techniciens', 'Statut'],
      columnWidths: { 0: const pw.FixedColumnWidth(60), 3: const pw.FixedColumnWidth(70) },
      data: items.map((i) => [
        DateFormat('dd/MM/yy').format(i.date),
        _clean(i.code),

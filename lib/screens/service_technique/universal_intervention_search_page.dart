...
class _UniversalInterventionSearchPageState
  ...
  String _searchQuery = '';
  List<DocumentSnapshot> _allInterventions = [];
  List<DocumentSnapshot> _filteredInterventions = [];
  ...
  void _filterInterventions(String query) {
    ...
    setState(() {
      ...
      _filteredInterventions = _allInterventions.where((doc) {
        ...
        // Assuming you have an intervention code field
        ...
        children: [
          Padding(
            ...
            child: TextField(
              ...
              autofocus: true, // Automatically focuses the search bar
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final data =
                  interventionDoc.data() as Map<String, dynamic>;
                  final closedDate =

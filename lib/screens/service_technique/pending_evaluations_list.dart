// lib/screens/service_technique/pending_evaluations_list.dart
...
class PendingEvaluationsListPage extends StatelessWidget {
  final String userRole;

  const PendingEvaluationsListPage({super.key, required this.userRole});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          'Évaluations Techniques à Faire', // Clarified title
  ...
  // Widget for the beautiful empty state (copied from previous design)
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              "Aucune évaluation technique n'est en attente pour le moment.", // Updated text
              style: GoogleFonts.lato(
                fontSize: 16,
                color: Colors.white.withOpacity(0.8),
              ),
